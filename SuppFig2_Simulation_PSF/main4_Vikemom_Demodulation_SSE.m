% For ptychographic recovery, adapted from the following references with additional OTF recovery implemented (Ye Ma).
...
for jj=1:50
    ...
    sumSquareError(jj)=sum(sum(abs(Iobj0-Iobj).^2));
end

plot(1:50,sumSquareError);
